...
#ifndef _VISUQVTKADAPTOR_RESECTION_HPP_
#define _VISUSVTKADAPTOR_RESECTION_HPP_
...
class VISUQVTKADAPTOR_CLASS_API Resection: public ::fwRenderVTK::IVtkAdaptorService
{

public:

    fwCoreServiceClassDefinitionsMacro ( (Resection)(::fwRenderVTK::IVtkAdaptorService::Baseclass) ) ;

    VISUQVTKADAPTOR_API Resection() throw();
    VISUQVTKADAPTOR_API virtual ~Resection() throw();
...
#endif // _VISUQVTKADAPTOR_RESECTION_HPP_
