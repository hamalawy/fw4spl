...
#include "ioQtTuto/ExternalDataReaderService.hpp"
...
{  
    QString file = QFileDialog::getOpenFileName(0,QObject::tr("Choose an external data file"), QDir::currentPath(), QObject::tr("External data (*.us)|*.us"));
