...
#include "ioQtTuto/CompositeWriterService.hpp"
#include <QFileDialog>
#include <QString>
...
void CompositeWriterService::configureWithIHM()
{
    ...
    QString file = QFileDialog::getSaveFileName(0,QObject::tr("Xml file to save"), QDir::currentPath(), QObject::tr("xml file (*.xml)|*.xml"));
