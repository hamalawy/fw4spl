...
class  FwXMLPatientDBWriterService : public ::io::IWriter
{
...
public :
     ...
     *
     */
     FwXMLPatientDBWriterService() throw();

    /**
     * @brief   destructor
     */
     virtual ~FwXMLPatientDBWriterService() throw();
...
protected:
    ...
    /// Override
     std::string getCfgExtensionPoint() ;

    /// Override
     virtual std::string getPersistanceId() ;
